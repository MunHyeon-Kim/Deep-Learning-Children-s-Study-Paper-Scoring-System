...
def run():
    ...
    parser.add_argument('--image_folder', default='TestImage', help='path to image_folder which contains text images')
    parser.add_argument('--workers', type=int, help='number of data loading workers', default=4)
    parser.add_argument('--batch_size', type=int, default=64, help='input batch size')
    parser.add_argument('--saved_model', default='saved_models/kocrnn_htr/best_accuracy.pth', help="path to saved_model to evaluation")
    """ Data processing """
