...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', required=True, help='deep-text-text_recogition_naverAi-benchmark/htr_data/train')
    parser.add_argument('--valid_data', required=True, help='deep-text-text_recogition_naverAi-benchmark/htr_data/validation')
    parser.add_argument('--manualSeed', type=int, default=1111, help='for random seed setting')
    parser.add_argument('--workers', type=int, help='number of data loading workers', default=4)
    parser.add_argument('--batch_size', type=int, default=192, help='512')
    ...
    parser.add_argument('--batch_max_length', type=int, default=25, help='200')
    ...
    """ Model Architecture """
    parser.add_argument('--Transformation', type=str, required=True, help='TPS')
    parser.add_argument('--FeatureExtraction', type=str, required=True,
                        help='ResNet')
    parser.add_argument('--SequenceModeling', type=str, required=True, help='BiLSTM')
    parser.add_argument('--Prediction', type=str, required=True, help='CTC')
